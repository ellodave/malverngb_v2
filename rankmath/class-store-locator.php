...
class Store_Locator {
	...
	public function get_data( $shortcode ) {
		...
		$radius   = Param::post( 'rank-math-search-radius', 1000 );
				...
				<form id="rank-math-local-store-locator" method="post" action="#rank-math-local-store-locator">
					...
					<?php if ( ! empty( $shortcode->atts['show_radius'] ) ) { ?>
						<div class="rank-math-form-field">
							<select name="rank-math-search-radius" class="hide">
								<?php
					...
					<div class="rank-math-form-field">
						<input type="text" name="rank-math-search-address" id="rank-math-search-address" placeholder="<?php echo esc_html__( 'Enter a location', 'rank-math-pro' ); ?>" value="<?php echo esc_attr( $address ); ?>" />
